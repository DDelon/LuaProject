...
function PayChannelListBase:onInit()
    ...
    self.channelInfoList = {
        Wechat = {type=SmallGamesGI.PaySDKType.Wechat, icon="pay_ico_wx.png", 	name="微信支付",  visible=(bit.band(PAY_SWITCH, 1) == 1 and true or false)},
        Alipay = {type=SmallGamesGI.PaySDKType.Alipay, icon="pay_ico_alipay.png", name="支付宝支付",visible=(bit.band(PAY_SWITCH, 2) == 2 and true or false) },
        Unionpay = {type=SmallGamesGI.PaySDKType.Unionpay, icon="pay_ico_union.png",  name="银联支付",  visible=(bit.band(PAY_SWITCH, 4) == 4 and true or false) },
        Apple = {type=SmallGamesGI.PaySDKType.Apple, icon="pay_ico_apple.png",  name="苹果支付",  visible=(bit.band(PAY_SWITCH, 8) == 8 and true or false) },
    }
end
